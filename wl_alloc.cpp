...
GENERIC wl_alloc::heap_pointer_val()
{
	return heap_pointer;
}
...
void wl_alloc::pchoices() /*  RM: Oct 28 1993  For debugging. */
{
	ptr_choice_point c;
...
void wl_alloc::print_undo_stack()
{
...
long wl_alloc::bounds_undo_stack()
...
void check_psi_list();
void check_resid_list(ptr_resid_list*); /* 21.9 */
void check_choice();
void check_undo_stack();
...
//#ifdef CLIFE
long wl_alloc::unchecked(GENERIC* p, long len)
// #else
//  long wl_alloc::unchecked (GENERIC *p, long len)
// #endif /* CLIFE */
// GENERIC *p; 
...
*/
void wl_alloc::check_string(GENERIC* s)
// GENERIC *s;
{
	GENERIC addr;
	long value;
...
/******** CHECK_BYTEDATA(s)
  ...
  */
void wl_alloc::check_bytedata(GENERIC* s)
//     GENERIC *s;
{
	GENERIC addr;
	long value;
...
*/
void wl_alloc::check_code(ptr_int_list* c)
// ptr_int_list *c;
{
...
*/
void wl_alloc::check_pair_list(ptr_pair_list* p)
// ptr_pair_list *p;
{
...
*/
void wl_alloc::check_triple_list(ptr_triple_list* p)
// ptr_triple_list *p;
{
...
*/
void wl_alloc::check_kids(ptr_int_list* c)
// ptr_int_list *c;
{
	while (unchecked((GENERIC*)c, sizeof(int_list))) {
...
*/
void wl_alloc::check_operator_data(ptr_operator_data* op)
...
void check_module(ptr_module*);
void check_hash_table();          /*  RM: Feb  3 1993  */
void check_keyword(ptr_keyword*);      /*  RM: Jan 12 1993  */
...
void wl_alloc::check_module_list(ptr_int_list* c)    /*  RM: Jan 12 1993  */
...
void wl_alloc::check_module(ptr_module* m)        /*  RM: Jan 12 1993  */
...
void wl_alloc::check_hash_table(ptr_hash_table table) /*  RM: Feb  3 1993  */
...
void wl_alloc::check_keyword(ptr_keyword* k)      /*  RM: Jan 12 1993  */
...
*/
void wl_alloc::check_definition(ptr_definition* d)
// ptr_definition *d;
{
...
*/
void wl_alloc::check_definition_list()   /*  RM: Feb 15 1993  */
...
*/
void wl_alloc::check_def_code(ptr_definition* d)
// ptr_definition *d;
{
	if (unchecked((GENERIC*)d, sizeof(definition)))
		check_code(&((*d)->code));
...
*/
void wl_alloc::check_def_rest(ptr_definition* d)
// ptr_definition *d;
{
	if (*d) {
		check_keyword(&((*d)->keyword)); /*  RM: Jan 12 1993  */
...
*/
void wl_alloc::check_type_disj(ptr_int_list* p)
// ptr_int_list *p;
{
...
*/
void wl_alloc::check_goal_stack(ptr_goal* g)
// ptr_goal *g;
{
...
*/
void wl_alloc::check_resid(ptr_residuation* r)
// ptr_residuation *r;
{
	ptr_int_list code;
	ptr_list* l;
...
*/
void wl_alloc::check_resid_block(ptr_resid_block* rb)
// ptr_resid_block *rb;
{
	if (*rb) {
...
/******** CHECK_PSI_TERM(t)
  Explore a psi_term.
*/
void wl_alloc::check_psi_term(ptr_psi_term* t)
// ptr_psi_term *t;
{
	ptr_list* l;
...
*/
void wl_alloc::check_gamma_code()
{
	long i;
...
*/
void wl_alloc::check_gamma_rest()
{
	long i;
...
*/
void wl_alloc::check_undo_stack(ptr_stack* s)
// ptr_stack *s;
{
...
*/
void wl_alloc::check_choice_structs(ptr_choice_point* c)
//     ptr_choice_point *c;
{
...
void wl_alloc::check_choice(ptr_choice_point* c)
//     ptr_choice_point *c;
{
	while (*c) {
...
*/
void wl_alloc::check_special_addresses()
{
	ptr_choice_point c;
	ptr_stack p;
	ptr_goal g;
...
/******** CHECK_PSI_LIST
  ...
  of psi_terms.
*/
void wl_alloc::check_psi_list(ptr_int_list* l)
// ptr_int_list *l;
{
...
*/
void wl_alloc::check_resid_list(ptr_resid_list* l)
// ptr_resid_list *l;
{
...
void wl_alloc::print_gc_info(long timeflag)
// long timeflag;
{
